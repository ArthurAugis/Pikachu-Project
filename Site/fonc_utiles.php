...
function searchPokemonListe($connexion)
{
    ...
    {   
        if($genre == "Male" || $genre == "Femelle")
        {
            ...
            $where = $where . "AND (tab_genres.TGE_libelle = '$genre' OR tab_genres.TGE_libelle = 'Les deux') ";
        }
        else
        {
            $join = $join . "JOIN tab_genres ON tab_pokedex.CLE_genre = tab_genres.CLP_genre ";
    ...
    else if(!empty($genre))
    {
        if($genre == "Male" || $genre == "Femelle")
        {
            ...
            $where = $where . " (tab_genres.TGE_libelle = '$genre' OR tab_genres.TGE_libelle = 'Les deux') ";
        }
        else
        {
            $join = $join . "JOIN tab_genres ON tab_pokedex.CLE_genre = tab_genres.CLP_genre ";
