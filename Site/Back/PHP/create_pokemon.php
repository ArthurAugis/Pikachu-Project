...
$connexion = connexion();
addPokemon($connexion, $nom, $numero, $taille, $poids, $genre, $points_vie, $attaque, $defense, $attaque_speciale, $defense_speciale, $vitesse, $categorie, $region, $photo, $faiblesses, $types, $evolutions, $talents, $versions, $author);
